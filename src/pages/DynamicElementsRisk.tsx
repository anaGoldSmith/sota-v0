  ...
  return <div className="min-h-screen bg-background">
      ...
      <header className="border-b bg-card">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <Button variant="ghost" size="icon" onClick={() => navigate("/routine-calculator")}>
          ...
          <Collapsible open={isOverviewOpen} onOpenChange={setIsOverviewOpen}>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle>Dynamic Elements Overview</CardTitle>
              ...
              <CollapsibleContent>
                <CardContent className="space-y-6 pt-4">
                  ...
                  <div>
                    <p className="font-medium mb-2">A valid Risk consists of the following parts:</p>
