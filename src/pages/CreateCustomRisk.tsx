                    ...
                    <div className="mt-2 w-full bg-background border border-border rounded-lg shadow-lg z-50 max-h-64 overflow-y-auto">
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <span className="text-foreground text-sm">Throw during DB <span className="text-primary">(0.1 is added for extra rotation)</span></span>
                  ...
                  {showCatchDropdown && (
                    <div className="mt-2 w-full bg-background border border-border rounded-lg shadow-lg z-50 max-h-64 overflow-y-auto">
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <span className="text-foreground text-sm">Catch during DB <span className="text-primary">(0.1 is added for extra rotation)</span></span>
