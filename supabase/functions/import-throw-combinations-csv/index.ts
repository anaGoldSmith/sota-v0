...
serve(async (req) => {
  ...
  try {
    ...
    const requiredColumns = ['code', 'Thr6', 'Thr7'];
    ...
    return new Response(
      JSON.stringify({ success: true, count: data.length, message: `Imported ${data.length} throw combinations` }),
