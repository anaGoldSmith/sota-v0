-- Drop existing control tables if they exist
DROP TABLE IF EXISTS public.hoop_control CASCADE;
DROP TABLE IF EXISTS public.ball_control CASCADE;
DROP TABLE IF EXISTS public.clubs_control CASCADE;
DROP TABLE IF EXISTS public.ribbon_control CASCADE;
